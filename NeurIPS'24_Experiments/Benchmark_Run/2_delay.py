...
lrs = [0.1]*2 + [0.05]*7 + [0.05]*10
q_skews = [2]*len(CBITSs)
rst_skews = [50]*len(CBITSs)
sizes = [(200000,50)]*9 + [(200000,100)]*len(CBITSs)
...
for dut_i in range(len(N_lims)):
	...
	state_vars, inp_out_vars = nuR.readForVars(name, module_name, iter(['Y', 0, N_lim, 'N', 'Y', rst_skew, 'N', 'N']))
